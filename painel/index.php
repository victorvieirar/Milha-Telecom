...
<body>
    ...
    if (!isset($_SESSION['admin'])) {
        ...
        ?>
        <div id="login">
            <h2 class="white bold uppercase">Toolsnet</h2>
    ...
    ?>
        <div id="main">
            ...
            <form id="plans-form" action="../php/operations/add-plan.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <div>
                    <label for="plan-image" class="blue bold uppercase">Banner do plano</label>
                    <input type="file" name="img" id="plan-image">
                </div>
                <div>
